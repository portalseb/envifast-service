...
public class GenerateNextWeekDateTimeUseCase implements GenerateNextWeekDateTimeService {
    ...
    @Override
    public void generateNextWeekDateTime(String fecha, Integer dias, Integer paraSim){generateNextWeekDateTimePort.generateNextWeekDateTime(fecha,dias,paraSim);}
}
